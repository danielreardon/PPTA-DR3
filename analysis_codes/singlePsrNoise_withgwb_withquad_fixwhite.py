...
#upper limits are 1000x the typical largest par file error
#lower limits are 100x lower than errobar
#coefficient of quadratic term
log10_a_quad = parameter.Uniform(-24, -16)
sgn_a = parameter.Uniform(-1, 1)
#coefficient of linear term
log10_b_quad = parameter.Uniform(-16, -9)
sgn_b = parameter.Uniform(-1, 1)
#coefficient of DC term
log10_c_quad = parameter.Uniform(-12, -8)
sgn_c = parameter.Uniform(-1, 1)
