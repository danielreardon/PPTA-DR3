...
bn_highmid = gp_signals.FourierBasisGP(rn_model, components=band_components,
                                       selection=high_mid_freq,name='band_noise_highmid')
...
if not reddm_only and not dir=='ppta15':
    ...
    if psr.name in ['J0437-4715', 'J0613-0200', 'J1017-7156', 'J1045-4509', 'J1600-3053', 'J1643-1224', 'J1909-3744', 'J1939+2134']: #'J1713+0747'
        s += bn
    if psr.name in ['J1713+0747']:
        s += bn_highmid
