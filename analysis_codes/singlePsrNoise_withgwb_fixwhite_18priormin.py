...
"""
log10_A_prior = parameter.Uniform(-18, -11)
...
"""
log10_A_dm_prior = parameter.Uniform(-18, -11)
...
if not dir == 'ppta15':
    max_cadence = 30 #days
    log10_A_gn_prior = parameter.Uniform(-18, -11)
...
"""
log10_A_chrom_prior = parameter.Uniform(-18, -11)
