...
if not reddm_only and not dir=='ppta15':
    ...
    if psr.name in ['J0437-4715', 'J0613-0200', 'J1017-7156', 'J1045-4509', 'J1600-3053', 'J1643-1224', 'J1909-3744', 'J1939+2134']:
        s += bn 
...
pta[0] = signal_base.PTA(s1(psr))
pta[1] = signal_base.PTA(s2(psr))
pta[2] = signal_base.PTA(s(psr))
